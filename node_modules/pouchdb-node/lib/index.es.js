...
PouchDB$3.adapter = function (id, obj$$1, addToPreferredAdapters) {
  /* istanbul ignore else */
  if (obj$$1.valid()) {
    PouchDB$3.adapters[id] = obj$$1;
...
PouchDB$3.plugin = function (obj$$1) {
  if (typeof obj$$1 === 'function') { // function style for plugins
    ...
    Object.keys(obj$$1).forEach(function (id) { // object style for plugins
      PouchDB$3.prototype[id] = obj$$1[id];
    });
  }
  if (this.__defaults) {
